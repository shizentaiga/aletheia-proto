...
-- 1. 開発用ユーザー
INSERT INTO users (user_id, email, display_name, role_id, status_id, plan_id)
VALUES 
('USER_TEST_GUEST', 'guest@example.com', 'テスト客', 0, 10, 'free');

-- 2. 交通ノード (駅データ：小岩・東京・田端の空間検索用)
INSERT INTO transport_nodes (node_id, name, type, line_name, geohash_9, lat, lng, address_prefix)
VALUES
...
INSERT INTO service_proposals (proposal_id, service_id, user_id, field_name, proposed_value, status_id)
VALUES
